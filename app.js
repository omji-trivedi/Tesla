...
const laptop = window.matchMedia("(max-width : 2000px)");
...
const ipad = window.matchMedia("(max-width : 850px)");
...
const phone = window.matchMedia("(max-width : 420px)");
